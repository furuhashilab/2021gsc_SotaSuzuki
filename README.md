...
二郎系ラーメンとは東京・三田に本店を構える『ラーメン二郎』で修行をした人や、その影響を受けて作られているラーメンの総称である。
二郎インスパイア系の中には直系のラーメン二郎ではないにも関わらず、過去に「ラーメン二郎」を名乗っていた店もあるが、「ラーメン二郎」の商標登録に伴い、店名を変更した店も多い。
「二郎系」とは「ラーメン二郎」を元祖としてそれを典型、模範、標準とするラーメンの系統、スタイルのこと。本家（三田本店）とは直接の関係がなく、ラーメンのスタイルが似た店のこと。「二郎インスパイア系」とも呼ばれる。
麺は極太のわしわし麺で器には麺を覆い隠すほどのもやしをはじめとした野菜が山盛りであり、ニンニク、背油などのトッピングを任意に選ぶことができるといった要素をおおむねの特徴としている。
